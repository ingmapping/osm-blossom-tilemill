...
#bridge[render='1_outline'][zoom>=11][zoom<=20]{
  ...
  [stylegroup='railway'] {
    line-opacity: 0;
    [bridge=1] { line-opacity: 1; line-color: @rail_case; }
    [bridge=1][type='subway'] { line-opacity: 0; }
  }
  [type='construction'],
  [type='abandoned'],
  [type='disused'] {
  ...
  /* -- widths -- */
  [zoom=11] {
    [stylegroup='motorway'] { line-width: @rdz11_maj + 0.7; }
    [stylegroup='mainroad'] { line-width: @rdz11_med + 0.7; }
  ...
  [zoom=13] {
    ...
    [stylegroup='mainroad'] { line-width: @rdz13_med + 1.2; }
...
#bridge[render='3_inline'][zoom>=11][zoom<=20]{
  ...
  [stylegroup='railway'] {
    ...
    [type='tram'] { line-opacity: 0; }
    [bridge=1] { line-color: @rail_bridge_fill; }
  ...
  [zoom>=18] {
    ...
    [stylegroup='noauto']   { line-width: @rdz18_min / 5; line-dasharray: 2,2; }
...
#bridge[render='2_line'][zoom>=14][zoom<=20]{
  /* -- colors & styles -- */
  [stylegroup='noauto'] {
    line-color: @pedestrian_bridge_case;
    line-width: 0;
    line-join: round;
  }
  [stylegroup='railway'] {
